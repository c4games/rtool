...
def parse_texturepacker_args(s):
    ...
    #parser.add_argument('image_path',nargs=argparse.REMAINDER)
    ...
    return (image_path,flag_arguments,key_value_arguments)

def create_texturepacker_args(image_path,flag_arguments,key_value_arguments):
