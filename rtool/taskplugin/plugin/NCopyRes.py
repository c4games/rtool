				...
				for ext in ext_list:						
					if ext == fext:
						if ext == '.fnt':
							...
							src_fnt = os.path.join(basedir,filename)
							src_png = os.path.join(basedir,name+'.png')
							if not os.path.exists(dest_dir):
								os.makedirs(dest_dir)
							logger.debug("[CopyRes]copy "+src_fnt+" to "+dest_dir)
							shutil.copy2(src_fnt,dest_dir)
							shutil.copy2(src_png,dest_dir)
