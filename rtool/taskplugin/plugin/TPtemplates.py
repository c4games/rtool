...
etcpack_alpha_command_template = "etcpack.exe $srcname $dstname -c etc1 -as"
etcpack_no_alpha_command_template = "etcpack.exe $srcname $dstname -c etc1"
astc_template = "astcenc.exe -cs $srcname $dstname 4x4 -medium"